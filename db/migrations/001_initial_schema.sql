...
ALTER TABLE cameras ADD COLUMN IF NOT EXISTS min_face_size INTEGER NOT NULL DEFAULT 40;
ALTER TABLE cameras ADD COLUMN IF NOT EXISTS quality_threshold INTEGER NOT NULL DEFAULT 35;
