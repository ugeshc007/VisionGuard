...
// function to create a new camera and sync it to the stream gateway
...
exports.update = async (req, res) => {
    ...
    const streamSync = await syncGatewayStream(camera).catch((error) => ({ ok: false, message: error.message }));
    return { camera: enrichCameraStream(camera), streamSync };
...
exports.remove = async (req, res) => {
    ...
    return { cameraId, message: "Camera deleted" };
...
exports.captureFrame = async (req, res) => {
    ...
    try {
        ...
        return captureCameraFrame(camera);
    } catch (error) {
